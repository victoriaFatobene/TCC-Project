...
const pizzasSalgadas = [
    { id: '1', nome: 'Calabresa', ingredientes: 'Molho de tomate, mussarela, calabresa fatiada e cebola.', preco: 45.90, imagem: 'https://images.unsplash.com/photo-1594007654729-407eedc4be65?q=80&w=1928&auto=format&fit=crop' },
    { id: '2', nome: 'Margherita', ingredientes: 'Molho de tomate, mussarela, fatias de tomate fresco e manjericão.', preco: 42.50, imagem: 'https://images.unsplash.com/photo-1598021680133-eb3a73319420?q=80&w=2148&auto=format&fit=crop' },
    { id: '3', nome: 'Frango com Catupiry', ingredientes: 'Molho de tomate, mussarela, frango desfiado e catupiry.', preco: 48.00, imagem: 'https://images.unsplash.com/photo-1604382354936-07c5d9983d34?q=80&w=2070&auto=format&fit=crop' },
    { id: '4', nome: 'Portuguesa', ingredientes: 'Molho, mussarela, presunto, ovos, cebola, pimentão e azeitonas.', preco: 52.00, imagem: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?q=80&w=1981&auto=format&fit=crop' },
];
